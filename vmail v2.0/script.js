...
$('#email-id-btn').on('click', function(e) {
  recognition.stop();
    ...
    notes.forEach(function(note) {
      html+= `<li class="note">
        <p class="header">
          ...
          <a href="#" class="listen-note" title="Listen to Note" style="color:#ceced6;">Listen to Note</a>
          <a href="#" class="delete-note" title="Delete" style="color:#ceced6;">Delete</a>
        </p>
        <p class="content" style="color:#ceced6;">${note.content}</p>
      </li>`;    
    });
  }
  else {
    html = '<li><p class="content" style="color:#babcbf;">You don\'t have any Email yet.</p></li>';
  }
  notesList.html(html);
}
